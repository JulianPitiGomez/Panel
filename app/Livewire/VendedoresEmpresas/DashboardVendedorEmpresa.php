...
class DashboardVendedorEmpresa extends Component
{
    public $pedidos = [];
    public $tablePrefix = '';
    ...
    public function cargarPedidos()
    {
        $this->pedidos = DB::connection('client_db')
            ...
            ->leftjoin("ma_pedidos_det as pe", 'p.id', '=', 'pe.idpedido')
    ...
    public function seleccionarCliente($codigo)
    {
        ...
        $id = DB::connection('client_db')
            ...
            ->insertGetId([
                ...
                'vendedor' => session('vendedor_empresa_nombre'),
                'fecha' => db::raw('CURDATE()'),
                'parafecha' => db::raw('CURDATE()'),
                'estado' => 'A'
            ]);

        return redirect('vendedores-empresas/pedido/editar/'.$id);
    }
    ...
    {
        return $this->redirect(route('logout.vendedores-empresas'), navigate: true);
    }
    ...
    {
        return view('vendedores-empresas.dashboard-vendedor-empresa');
    }
}
