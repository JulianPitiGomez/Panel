...
class GestorPedidosVendedorEmpresa extends Component
{
    public $pedidoId;
    public $clienteId;
    public $cliente;
    ...
    public function obtenerPrecioCliente($codigo)
    {
        ...
        return $lispre == 2 ? $producto->REVENTA : $producto->PRECIO;
    }
    ...
    {
        return view('vendedores-empresas.gestor-pedido-vendedor-empresa');
    }
}
