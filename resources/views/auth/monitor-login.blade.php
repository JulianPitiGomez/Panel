            ...
            <div class="flex justify-center">
                <div class="flex items-center space-x-6">
                    ...
                    <div class="text-center">
                        <h1 class="text-2xl md:text-4xl font-bold text-white">Monitor de Pedidos</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <main class="flex-grow flex items-center justify-center px-4 py-8 bg-[#222036]">
        <div class="w-full max-w-md mx-auto">
            ...
            <div class="bg-[#222036] rounded-2xl shadow-xl p-8 ">
                <form method="POST" action="{{ route('authenticate.monitor') }}">
                    @csrf
                    ...
                    <div class="mb-6">
                        <label for="mail" class="block font-secondary font-semibold text-white text-sm mb-3">
                            ...
                            Ingresa el Nro de Comercio
                        </label>
                        <input type="text" 
                               id="id" 
                               name="id" 
                               placeholder="Nro de comercio"
