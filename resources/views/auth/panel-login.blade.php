            ...
            <div class="flex justify-center">
                <div class="flex items-center space-x-6">
                    ...
                    <div class="text-center">
                        <h1 class="text-2xl md:text-4xl font-bold text-white">Panel de Control</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <main class="flex-grow flex items-center justify-center px-4 py-8 bg-[#222036]">
        <div class="w-full max-w-md mx-auto">
            ...
            <div class="bg-[#222036] rounded-2xl shadow-xl p-8 ">
                <form method="POST" action="{{ route('authenticate.panel') }}">
                    @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <input type="email" 
                               ...
                               class="bg-white w-full px-4 py-3 border border-white rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors font-secondary @error('mail') border-red-500 ring-2 ring-red-200 @enderror"
                               required>
                        @error('mail')
                    ...
                    <div class="mb-8">
                        ...
                        <input type="password" 
                               ...
                               name="password"
                               placeholder="••••••••"
                               class="bg-white w-full px-4 py-3 border border-white rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors font-secondary @error('password') border-red-500 ring-2 ring-red-200 @enderror"
                               required>
                        @error('password')
                            <p class="text-red-500 text-sm font-secondary mt-2 flex items-center">
                                <i class="fas fa-exclamation-circle mr-1"></i>
