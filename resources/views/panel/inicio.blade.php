            ...
            <div class="flex flex-col sm:flex-row gap-3">
                ...
                <div class="flex items-end">
                    <button wire:click="cargarDatos" wire:loading.attr="disabled"
                            class="btn-primary px-4 py-2 rounded-lg text-sm disabled:opacity-50">
    ...
    <div class="bg-white rounded-xl shadow-md p-6 border border-gray-100">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-4 border border-purple-200">
                <p class="text-sm font-secondary text-purple-700 mb-2">{{ $depto['departamento'] }}</p>
                <p class="text-xl font-primary font-bold text-purple-800">${{ number_format($depto['total'], 2) }}</p>
            </div>
            @endforeach
        </div>
    </div>
