<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-orange-50 to-orange-100 rounded-xl p-6 border border-orange-200">
        <div class="flex items-center justify-between">
            <div>
                <h3 class="text-lg font-primary font-semibold text-gray-800">Total de Pagos a Proveedores</h3>
                <p class="text-sm font-secondary text-gray-600">{{ $pagos->total() ?? 0 }} órdenes de pago encontradas</p>
            </div>
        ...
        <div class="{{ $mostrarDetallePago ? 'w-2/3' : 'w-full' }} transition-all duration-300 overflow-hidden">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                ...
                <div class="text-center py-12">
                    ...
                    <h3 class="text-lg font-primary font-medium text-gray-900 mb-2">No hay órdenes de pago</h3>
                    <p class="text-gray-600 font-secondary">No se encontraron órdenes de pago con los filtros seleccionados</p>
                </div>
                @endif
            </div>
            @endif
            ...
            <div class="h-full flex flex-col max-h-[800px]">
                ...
                <div class="p-4 border-b border-gray-200 bg-gray-50">
                    <div class="grid grid-cols-1 gap-3 text-sm">
                        <div class="flex justify-between">
                            ...
                            <span class="font-secondary text-gray-900">{{ $pagoSeleccionado->cliente_nombre ?? 'Proveedor #' . $pagoSeleccionado->CLIENTE }}</span>
                        </div>
                        <div class="flex justify-between">
                ...
                <div class="border-t border-gray-200 p-4 bg-gray-50">
                    <div class="flex justify-between items-center">
                        <span class="font-secondary font-bold text-gray-900">TOTAL ORDEN:</span>
