<div class="space-y-6">
    ...
    <div class="flex gap-6">
        <!-- Contenido Principal -->
        <div class="{{ $mostrarDetallePedido ? 'w-2/3' : 'w-full' }} transition-all duration-300 overflow-hidden">
        ...
        <div class="w-1/3 bg-white border border-gray-200 rounded-xl shadow-lg overflow-hidden">
            <div class="h-full flex flex-col max-h-[800px]">
                ...
                <div class="flex items-center justify-between p-4 border-b border-gray-200 bg-gray-50">
                    ...
                    <button wire:click="cerrarDetallePedido" class="text-gray-400 hover:text-gray-600 p-1">
